...
public class MainActivity extends AppCompatActivity
    ...
    private void addItemsRunTime(NavigationView navigationView) {
       ...
       /* for (int i = 1; i <= 3; i++) {
            menu.add(1, i, 0,"Runtime item "+ i);
        }
        menu.setGroupCheckable(1,true,true);*/
        // adding a section and items into it
        final SubMenu subMenu = menu.addSubMenu("Select a Category");
        for (int i = 1; i <= 5; i++) {
            subMenu.add(0, i, 0,"SubMenu Item " + i).setIcon(getResources().getDrawable(R.drawable.iconcategory));
